...
def get_activities(
    ...
    - difficulty_level: Filter by difficulty level ('Beginner', 'Intermediate', 'Advanced', or 'all' for activities with no difficulty set)
    """
    ...
    if difficulty_level:
        if difficulty_level.lower() == "all":
            # Filter for activities with no difficulty level set
